export default function CardContainer() {
  return (
    <section>
      <p className='text-[22px] font-semibold mt-6'>Shop Top Brands</p>
...
const Card = () => {
  return (
    <div className='bg-white border rounded-lg border-slate-400/20 p-1.5 '>
      <div className='h-36 w-full bg-neutral-100 rounded-lg border backdrop-blur-[20px]'>
        <img
      ...
      <p className='text-xs font-semibold text-center pt-1.5 '>Fender</p>
    </div>
  );
};

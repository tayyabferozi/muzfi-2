...
const Post = ({ el, idx }) => {
  ...
  return (
    <Card className="home-post" key={"home-post" + idx}>
      <div className="flex justify-between items-center mb-4">
        <div className="sm:flex-nowrap flex-wrap flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="text-accentGray-700 text-xs">•</div>
            <div className="text-accentGray-700 text-xs">
              Posted by {el.author}
            </div>
            <div className="text-accentGray-700 text-xs">•</div>
            <div className="text-accentGray-700 text-xs">
      ...
      <div className="mt-3 flex justify-between items-center gap-4 flex-wrap">
        ...
        <div className="flex flex-col items-end justify-center">
          {el.type === "prod-sale" || el.type === "prod-bid" ? (
            ...
            <div className="sm:block hidden text-sm text-accentGray-700">
              {el.location}
            </div>
          )}
        </div>
      ...
      <div className="sm:hidden block mt-2 text-sm text-accentGray-700">
        {el.location}
      </div>
      ...
      {el.type !== "prod-sale" && el.type !== "prod-bid" && (
        <>
          {el.postTitle && (
            <div className="text-2xl font-medium mt-3">{el.postTitle}</div>
          )}
              ...
              {isExpandedState ? (
                <>
                  ...
                  {el.postText.length > 194 && (
                    <span
                      className="text-accentYellow-500 cursor-pointer"
      ...
      {el.prodDescription && (
        <div className="mt-4 text-xs text-accentGray-800 font-medium">
          {el.prodDescription}
        </div>
      )}

      {el.imgs && (
        <div className="mt-3 flex sm:flex-nowrap flex-wrap gap-2">
            ...
            return (
              ...
              >
                {idx2 === el.imgs.length - 1 && (
                  <div className="img-overlay text-white absolute left-0 right-0 top-0 bottom-0 flex justify-center items-center text-xl font-semibold">
                    +45
                  </div>
                )}
                <img
          ...
          {el.tags.map((el2, idx2) => {
            return (
              <div
                ...
                className="bg-accentGray-400 text-sm font-medium py-1 px-2 rounded-3xl"
              >
                {el2}
              </div>
            );

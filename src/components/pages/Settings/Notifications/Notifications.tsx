  ...
  return (
    <>
      <Card className="p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">Chat requests</h4>
          <Switch />
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">New followers</h4>
          <Switch />
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">Pinned posts</h4>
          <Switch />
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">Awards you receive</h4>
          <Switch />
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">Posts you follow</h4>
          <Switch />
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">Posts you follow</h4>
        ...
        <h5 className="text-base text-accentGray-700">RECOMMENDATIONS</h5>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">Trending posts</h4>
          <Switch />
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 my-3">
          <h4 className="text-semibold text-[20px]">ReReddit</h4>
          <Switch />
        </div>
      </Card>
    </>

          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 mt-5">
              <div>
                ...
                <h5 className="text-sm text-accentGray-700">
                  Allow us to use your interactions on Reddit and account
                  information to show you better ads.
                </h5>
              </div>
              <Switch />
            </div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 mt-6">
              <div>
                ...
                <h5 className="text-sm text-accentGray-700">
                  Allow us to use information that our advertising partners send
                  us to show you better ads.
                </h5>
              </div>
              <Switch />
            </div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 mt-6">
              <div>
                ...
                <h5 className="text-sm text-accentGray-700">
                  Allow us to use your interactions with sites and apps we
                  partner with to show you better ads.
                </h5>
              </div>
              <Switch />
            </div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 mt-6">
              <div>
                ...
                <h5 className="text-sm text-accentGray-700">
                  Allow us to use your city, state, or country (based on your
                  IP) to recommend better posts and communities.
                </h5>
              </div>
              <Switch />
            </div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-11 mt-6">
              <div>
                ...
                <h5 className="text-sm text-accentGray-700">
                  Allow us to use your interactions with sites and apps we
                  partner with to recommend better posts and communities.
                </h5>
              </div>
              <Switch />
            </div>
